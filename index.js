...
//res.write("<form action='/index' method='post'><select name='startpoint'><option value='delhi'>Delhi</option><option value='chandigarh'>Chandigarh</option></select><select name='destpoint'><option value='delhi'>Delhi</option><option value= 'chandigarh'>Chandigarh</option></select><input type='submit' name='submit'></form> ");
